  ...
  return (
    <div style={{
      ...
      {[
        {
          icon: "❌",
          label: "Old approach: i.i.d. random draws",
          color: C.red,
          points: [
            "Every year is drawn independently",
            "No memory of what happened last year",
            "Can generate Bull→Bear→Bull in 3 years",
            "Understates sequence-of-returns risk",
            "Overstates diversification benefit",
          ],
        },
        {
          icon: "✅",
